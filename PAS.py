...
if seasonalData:
	...
	for si in range(4):
		...
		data2 = ptt.maskDraftXY(data2, grid, 0, timeDep=False, subregion=True, lons=lonsi, lats=latsi)

		data3 = ptt.maskDraftXY(data3, grid, 0, timeDep=False, subregion=True, lons=lonsi, lats=latsi)
